...
function b(q){for(var v=g,r=0;64>r;r+=4)v[r/4]=q[r]<<24|q[r+1]<<16|q[r+2]<<8|q[r+3];for(r=16;80>r;r++)q=v[r-3]^v[r-8]^v[r-14]^v[r-16],v[r]=(q<<1|q>>>31)&4294967295;q=e[0];var B=e[1],K=e[2],ma=e[3],Wc=e[4];for(r=0;80>r;r++){if(40>r)if(20>r){var Ja=ma^B&(K^ma);var Kb=1518500249}else Ja=B^K^ma,Kb=1859775393;else 60>r?(Ja=B&K|ma&(B|K),Kb=2400959708):(Ja=B^K^ma,Kb=3395469782);Ja=((q<<5|q>>>27)&4294967295)+Ja+Wc+Kb+v[r]&4294967295;Wc=ma;ma=K;K=(B<<30|B>>>2)&4294967295;B=q;q=Ja}e[0]=e[0]+q&4294967295;e[1]=
e[1]+B&4294967295;e[2]=e[2]+K&4294967295;e[3]=e[3]+ma&4294967295;e[4]=e[4]+Wc&4294967295}
...
;function Vc(a){x.setTimeout(function(){throw a;},0)}
var Xc;
...
var ed=!1,fd=new Zc;function gd(){for(var a;a=fd.remove();){try{a.f.call(a.scope)}catch(b){Vc(b)}Uc(ad,a)}ed=!1}
...
var Ud=Vc;function Ld(a){F.call(this,a)}
...
function Xg(a,b,c){c=void 0===c?null:c;var d=Yg(a),e=document.getElementById(d),f=e&&Sg(e,"loaded"),g=e&&!f;f?b&&b():(b&&(f=kf(d,b),b=""+Da(b),Zg[b]=f),g||(e=$g(a,d,function(){Sg(e,"loaded")||(Qg(e),nf(d),T(Ia(of,d),0))},c)))}
...
function bi(a){var b=ci(a),c=document.getElementById(b),d=c&&Sg(c,"loaded");d||c&&!d||(c=di(a,b,function(){Sg(c,"loaded")||(Qg(c),nf(b),T(Ia(of,b),0))}))}
...
function Qi(a){a=a||"";var b=z("ytcsi.reference");b||(Pi(),b=z("ytcsi.reference"));if(b[a])return b[a];var c=Pi(),d={timerName:a,info:{},tick:{},span:{}};c.push(d);return b[a]=d}
...
Si.prototype.span=function(a,b){var c=Object.keys(a).join("");Ui(this,"span_"+c+"_"+b)||(a.clientActionNonce=b,Gg("latencyActionSpan",a))};
...
;function mj(a){a=void 0===a?!1:a;N.call(this);this.f=new P(a);Hc(this,Ia(Ic,this.f))}
...
n.dispose=function(){vj.prototype.dispose.call(this);for(var a=0;a<this.h.length;a++){var b=this.h[a];this.f.removeEventListener(b.eventType,b.listener)}this.h=[]};function zj(a,b,c){N.call(this);this.f=a;this.i=c;this.j=X(window,"message",C(this.l,this));this.h=new nj(this,a,b);Hc(this,Ia(Ic,this.h))}
...
null):f.loadNewVideoConfig(a):(f=new ei(b,e,a,void 0),ti[e]=f,nf("player-added",f.api),Hc(f,Ia(vi,f)));a=f.api;Sj=a;a.addEventListener("onScreenChanged",Xj);a.addEventListener("onLogClientVeCreated",Wj);a.addEventListener("onLogServerVeCreated",Yj);a.addEventListener("onLogVeClicked",Zj);a.addEventListener("onLogVesShown",ak);d=R("POST_MESSAGE_ID","player");R("ENABLE_JS_API")?Uj=new yj(a):R("ENABLE_POST_API")&&"string"===typeof d&&"string"===typeof c&&(Tj=new zj(window.parent,d,c),Uj=new tj(a,Tj.h));
